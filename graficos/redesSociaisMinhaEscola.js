...
async function redesSociaisFavoritasMinhaEscola(){
    ...
    const redesSocias = dados.slice(1).map(redes => redes[1])

    const contagemRedesSociais = redesSociais.reduce((acc,redesScoais) => {
...
const layout = {
    ...
    height: 700,
    title: {
        text: 'Redes sociais que as pesoas da minha escola mais gostam',
        x: 0,
        font: {
